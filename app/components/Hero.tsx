  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {icons.map((IconComponent, index) => (
        ...
        >
          <IconComponent.Icon
            className={`w-8 h-8 ${IconComponent.color} opacity-20`}
          />
        </motion.div>
      ))}
    </div>
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 pt-32 pb-20 relative z-10">
        {useIsMobile() && (
          <div style={{ marginTop: "-20px" }} className="mb-12">
            {renderCubes()}
          </div>
        )}
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            >
              Specialized in building scalable front-end applications using
              React.js, Next.js, Redux Thunk, and RTK Toolkit — with expertise
              in data visualization (Chart.js), UI design (Ant Design), and
